...
if("TRUE" STREQUAL "TRUE")
  set(barrett_model_SOURCE_PREFIX /catkin_ws/src/barrett_model)
  set(barrett_model_DEVEL_PREFIX /catkin_ws/devel)
  ...
  set(barrett_model_INSTALL_PREFIX /catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/barrett_model " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/barrett_model' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'barrett_model' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'barrett_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/barrett_model/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT barrett_model_NUM_DUMMY_TARGETS)
      set(barrett_model_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::barrett_model::wrapped-linker-option${barrett_model_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR barrett_model_NUM_DUMMY_TARGETS "${barrett_model_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::barrett_model::wrapped-linker-option${barrett_model_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND barrett_model_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${barrett_model_dep}_FOUND)
      find_package(${barrett_model_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${barrett_model_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(barrett_model_EXPORTED_TARGETS ${${barrett_model_dep}_EXPORTED_TARGETS})
endforeach()
